...
for(x=0;x<32;x++){
for(y=0;y<32;y++){
w.emit("msg",{script:'new Uint8Array(img.data.buffer)[0+'+x+'*4+'+y+'*4*32]=255'})
w.emit("msg",{script:'new Uint8Array(img.data.buffer)[1+'+x+'*4+'+y+'*4*32]=0'})
w.emit("msg",{script:'new Uint8Array(img.data.buffer)[2+'+x+'*4+'+y+'*4*32]=0'})
